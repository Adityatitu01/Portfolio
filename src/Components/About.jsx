...
const About = () => {
  return (
    <div className='border-b justify-center lg:-ml-24 2xl:mx-16 md:-ml-22 border-neutral-900'>
      ...
      transition={{duration:0.5}} className='bg-slate-50 w-36 flex items-center gap-1 justify-center lg:mt-4 rounded md:mt-4 sm:mt-4 text-center md:ml-48 ml-44 mt-2 lg:ml-0'><h2 className='inline text-2xl text-neutral-600 font-semibold '>Resume</h2><a className='text-3xl font-semibold ' href="https://drive.google.com/file/d/1BOpu1Qt0BwTmmY_-F1ePHwbF48iLA9WT/view?usp=drive_link"> <IoMdDownload className='inline text-3xl text-indigo-500' /></a></motion.div> </p>
